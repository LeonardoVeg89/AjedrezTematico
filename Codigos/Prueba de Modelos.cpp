...
int main()
{
	...
	Model Medusa((char*)"Models/Medusa.obj");
	Model Gary((char*)"Models/Gary.obj");
	Model Caballo((char*)"Models/seahorse.obj");
	Model Neptuno((char*)"Models/Neptuno.obj");
	Model Torre((char*)"Models/Squidwards House.obj");
	Model Patricio((char*)"Models/patricio.obj");
	Model Arenita((char*)"Models/sandy_bikini_bind.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// *Modelos de personajes del mundo de Garfield*
		//Garfield.Draw(lightingShader);


		// *Modelos puesto de globos*
		//Puesto.Draw(lightingShader);
		//BalloonJ.Draw(lightingShader);
		//BalloonO.Draw(lightingShader);
		//BalloonN.Draw(lightingShader);
		//BalloonG.Draw(lightingShader);
		//Dardo.Draw(lightingShader);
		
		// *Modelos del puesto de jaula de bateo*
		//Bate.Draw(lightingShader);
		//Bola.Draw(lightingShader);

		// *Modelos Tablero de Ajedrez*
		
		//Patricio.Draw(lightingShader);
		//Arenita.Draw(lightingShader);
		//Tablero.Draw(lightingShader);		
		//Medusa.Draw(lightingShader);
		//Caballo.Draw(lightingShader);
		//Neptuno.Draw(lightingShader);
